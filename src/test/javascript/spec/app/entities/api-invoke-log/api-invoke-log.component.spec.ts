...
describe('Component Tests', () => {
  describe('ApiInvokeLog Management Component', () => {
    ...
    it('Should call load all on init', async () => {
      ...
      expect(comp.apiInvokeLogs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      apiInvokeLogServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(apiInvokeLogServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(apiInvokeLogServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(apiInvokeLogServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
