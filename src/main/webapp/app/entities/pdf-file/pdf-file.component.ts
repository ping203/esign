...
export default class PdfFile extends mixins(AlertMixin) {
  ...
  public retrieveAllPdfFiles(): void {
  ...
  public prepareRemove(instance: IPdfFile): void {
  ...
  public removePdfFile(): void {
    this.pdfFileService()
      ...
      .then(() => {
        const message = this.$t('esignApp.pdfFile.deleted', { param: this.removeId });
