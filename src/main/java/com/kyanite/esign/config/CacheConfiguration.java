package com.kyanite.esign.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.kyanite.esign.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.kyanite.esign.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.kyanite.esign.domain.DdUser.class.getName() + ".pdfFiles");
